...
Edit `agents/config.py` and add your API key:
```python
GEMINI_API_KEY = "your_gemini_api_key_here"
```
...
For your hackathon presentation, highlight these key features:

1. **Multi-Agent System**: Explain how different AI agents work together
2. **Personalization**: Show how recommendations change based on user personas
3. **Real-time Analysis**: Demonstrate the image processing and analysis speed
4. **Health Insights**: Showcase the detailed ingredient analysis
5. **User Experience**: Emphasize the clean, intuitive interface
